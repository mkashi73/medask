...
SECRET_KEY = 'django-insecure-l+lwpyx5sfr3#o@%zlw$z)ga_cn9zcr7hqhr15gb#*a-l$(%5i'
...
DATABASE_ROUTERS = ['api.routers.MyRouter']
...
STATIC_URL = '/medask/static/'

MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
MEDIA_URL = '/medask/media/'
...
# CSRF_COOKIE_DOMAIN = ".joinpakarmy.gov.pk"
