<template>
  <b-card no-body class="card-browser-states h-100">
    <b-card-header>
      <div>
        <b-card-title>Rank Wise NOC</b-card-title>
        <b-card-text class="font-small-2"> August 2020 </b-card-text>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      chartSeries: [54.4, 6.1, 14.6, 4.2, 8, 52],
      browserData: [
        {
          browserImg: require("@/assets/images/icons/rocket.svg"),
          name: "Record 1",
          usage: "54.4%",
        },
        {
